export class SqlSheetConfiguration {
    ...
    public static readonly parameterDescriptions: Record<string, string> = {
        ...
        table_name: "A title for the table (defaults to the SQL filename if not specified)",
        table_namet: "An alternative name for the table",
    ...
    constructor(
        ...
        public readonly table_namet?: string,
